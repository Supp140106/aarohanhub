...
import { getUnansweredQueryCount } from '@/app/actions/support';
...
export default async function DashboardPage() {
    ...
    const queryCount = await getUnansweredQueryCount();
            ...
            <div className="flex-1 px-8 py-6 max-w-7xl mx-auto w-full flex flex-col justify-center overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-full max-h-[85vh]">
                    ...
                    <ScrollReveal className="md:col-span-12">
                        <SpotlightCard spotlightColor="rgba(0, 240, 255, 0.2)" className="w-full">
                            <div className="relative p-6 md:p-8 rounded-[1.5rem] bg-gradient-to-r from-[#00F0FF]/5 to-transparent border border-white/5 overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h1 className="text-3xl md:text-5xl font-black tracking-tighter leading-[0.9] mb-4 text-white">
                    ...
                    <ScrollReveal delay={0.3} className="md:col-span-8">
                        <SpotlightCard className="h-full min-h-[140px]" spotlightColor="rgba(0, 240, 255, 0.4)">
                            <Link href="/events" className="block h-full p-6 group relative overflow-hidden">
                                ...
                                <div className="relative z-10 flex flex-col justify-between h-full">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-black tracking-tight mb-1 text-white">Events Hub</h2>
                    ...
                    <ScrollReveal delay={0.4} className="md:col-span-4 h-full">
                        <SpotlightCard className="h-full min-h-[140px] border-[#BF00FF]/20" spotlightColor="rgba(191, 0, 255, 0.4)">
                            <Link href="/admin/users" className="block h-full p-6 group transition-all relative overflow-hidden text-left w-full">
                                ...
                                <div className="relative z-10 flex flex-col justify-between h-full">
                                    <div>
                                        ...
                                        <h3 className="text-xl font-black tracking-tight leading-none mb-1 text-white">User Matrix</h3>
                    ...
                    <ScrollReveal delay={0.5} className="md:col-span-5 h-full">
                        <SpotlightCard className="h-full min-h-[140px]" spotlightColor="rgba(0, 240, 255, 0.4)">
                            <Link href="/support" className="block h-full p-6 group transition-all">
                                ...
                                <h3 className="text-lg font-black mb-1 leading-none text-white">Query Node</h3>
                                ...
                                <div className="flex items-center gap-1.5 px-2 py-1 bg-[#00F0FF]/10 w-fit rounded-md">
                                    ...
                                    <span className="text-[8px] font-black text-[#00F0FF] uppercase tracking-widest">{queryCount} New Requests</span>
                                </div>
                            </Link>
                        </SpotlightCard>
                    </ScrollReveal>

                    <ScrollReveal delay={0.6} className="md:col-span-7 h-full">
                        <SpotlightCard className="h-full min-h-[140px] border-emerald-500/20" spotlightColor="rgba(16, 185, 129, 0.4)">
                            <Link href="/logistics" className="block h-full p-6 group transition-all relative overflow-hidden">
                                ...
                                <div className="relative z-10 flex items-center justify-between h-full">
                                    <div>
                                        ...
                                        <h3 className="text-2xl font-black tracking-tight mb-1 text-white">Logistics Deck</h3>
