                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar pr-4 pb-20">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <ScrollReveal delay={0.1} className="md:col-span-2">
                                <SpotlightCard spotlightColor="rgba(0, 240, 255, 0.2)">
                            ...
                            <ScrollReveal delay={0.2} className="h-full">
                                <SpotlightCard spotlightColor={logistics?.foodCouponProvided ? "rgba(16, 185, 129, 0.2)" : "rgba(249, 115, 22, 0.2)"} className="h-full">
